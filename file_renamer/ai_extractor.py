    ...
    def __init__(self, api_key: str, model_name: str = "claude-3-5-sonnet-20241022"):
        ...
        self.agent = Agent(
            ...
            system_prompt=(
                ...
                "- ALWAYS look for subtitles - they are very common in academic works and should be extracted separately\n"
                "- Title should be the main title only (before colon, dash, underscore, or explanatory phrases)\n"
                "- Subtitle should be the descriptive part after separators like :, -, _, or explanatory phrases\n"
                "- Common subtitle patterns: 'Title: Subtitle', 'Title - Subtitle', 'Title_ Subtitle', 'Title. Subtitle'\n"
                ...
                "- 'Magistra Vitae_ Essays zum Lehrgehalt der Geschichte' → title='Magistra Vitae', subtitle='Essays zum Lehrgehalt der Geschichte'\n"
                "- 'Philosophy of Money. A Sociological Analysis' → title='Philosophy of Money', subtitle='A Sociological Analysis'\n"
